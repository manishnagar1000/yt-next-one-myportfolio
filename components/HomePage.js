...
const HomePage = () => {
  return (
    <div
      id="home"
      className="h-screen w-full text-center  bg-fixed bg-center bg-cover custom-img"
    >
      <div className="max-w-screen-3xl mx-auto w-full h-full pt-24 p-4 flex flex-col justify-center items-center ">
        ...
        <h1 className="uppercase font-bold text-white text-2xl md:text-7xl my-4">
          Frontend developer
        </h1>
        <p className="text-white text-xl max-w-sm mx-auto">
          I have 2 year of experience in building and desgining software.Currently
          ,I love to work on web applications using technologies like Javascript, React,
          Tailwind ,Next Js and Nodejs.
        </p>
        <Link href="/#me">
